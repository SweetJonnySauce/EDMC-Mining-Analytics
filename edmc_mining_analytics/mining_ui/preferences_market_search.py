...
def create_market_search_section(
    ...
    desc = tk.Label(
        frame,
        text="Configure Spansh market search filters for estimated sell prices.",
        anchor="w",
        justify="left",
        wraplength=420,
    )
    ...
    has_large_pad_cb.grid(row=1, column=0, columnspan=2, sticky="w", pady=(0, 8))

    sort_label = tk.Label(frame, text="Sort by", anchor="w")
    sort_label.grid(row=2, column=0, sticky="w", pady=(0, 6))
    ...
    min_demand_entry.grid(row=3, column=1, sticky="w", pady=(0, 6))
    ...
    age_label.grid(row=4, column=0, sticky="w", pady=(0, 6))
    ...
    age_entry.grid(row=4, column=1, sticky="w", pady=(0, 6))
    ...
    distance_label.grid(row=5, column=0, sticky="w", pady=(0, 6))
    ...
    distance_entry.grid(row=5, column=1, sticky="w", pady=(0, 6))
