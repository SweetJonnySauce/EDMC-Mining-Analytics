...
class SessionRecorder:
    ...
    def _estimated_sell_snapshot(self, captured_at: datetime) -> dict[str, Any]:
        ...
        priced_tons = float(breakdown.get("priced_tons") or 0.0)
        total_tons = float(breakdown.get("total_tons") or 0.0)
        priced_commodities = int(breakdown.get("priced_commodities") or 0)
        unpriced_commodities = int(breakdown.get("unpriced_commodities") or 0)
        ...
        return {
            ...
            "sort_mode": sort_mode,
            "priced_commodities": priced_commodities,
            "unpriced_commodities": unpriced_commodities,
